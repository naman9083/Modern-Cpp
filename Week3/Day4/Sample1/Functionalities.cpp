...
{
    data.push_back(Employee("Naman", 21000.0f, "Software Developer", 2));
...
void createEmployeesPointer(EmployeeRawCon &data)
{
    ...
    data.push_back(new Employee("Asim", 195000.0f, "Designer", 3));
    data.push_back(new Employee("Vishal", 210000.0f, "Designer", 1));
}
