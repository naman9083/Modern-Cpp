...
*/
Car::Car(CarType c1,std::string carId, std::string model, EnginePointer engine) : carId{carId}, _model{model}, engine{engine},c1{c1}
{
}
...
*/
Car::Car(CarType c1,std::string carId, float price, std::string model, EnginePointer engine) : Car(c1,carId, model, engine)
{
    _price = price;
}
...
EnginePointer Car::getEngine() const
{
    return engine;
}
